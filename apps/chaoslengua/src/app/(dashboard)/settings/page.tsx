...
export default function SettingsPage() {
            ...
            try {
                ...
                if (typeof window !== "undefined" && data.preferences) {
                    localStorage.setItem(
                        "chaoslengua-reduce-motion",
                        data.preferences.reduceMotion ? "true" : "false"
                    )
                    localStorage.setItem(
                        "chaoslengua-font-scale",
        ...
        try {
            ...
            if (typeof document !== "undefined") {
                if (field === "reduceMotion") {
                    ...
                    localStorage.setItem("chaoslengua-reduce-motion", value ? "true" : "false")
                }
                if (field === "fontScale") {
                    ...
                    localStorage.setItem("chaoslengua-font-scale", value)
                }
            }
    ...
    const handleExportData = async () => {
        try {
            ...
            a.href = url
            a.download = `chaoslengua-data-export-${new Date().toISOString().split("T")[0]}.json`
